...
public partial class HospitalDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCA2B835D89E");
        ...
        {
            entity.HasKey(e => e.DoctorId).HasName("PK__Doctor__2DC00EDF95FDADC4");

            entity.ToTable("Doctor");

            entity.HasIndex(e => e.FullName, "IX_Doctor_FullName");

            entity.HasIndex(e => e.Email, "UQ__Doctor__A9D10534D86EA549").IsUnique();
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDF647E178F7");
            ...
            entity.HasOne(d => d.Package).WithMany(p => p.Feedbacks)
                .HasForeignKey(d => d.PackageId)
                .HasConstraintName("FK__Feedback__Packag__66603565");

            entity.HasOne(d => d.Patient).WithMany(p => p.Feedbacks)
                .HasForeignKey(d => d.PatientId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Feedback__Patien__6477ECF3");
        ...
        {
            entity.HasKey(e => e.InvoiceDetailId).HasName("PK__InvoiceD__1F1578F18D6F7CCA");
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.InvoiceDetails)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__InvoiceDe__Appoi__72C60C4A");
        });

        modelBuilder.Entity<News>(entity =>
        {
            entity.HasKey(e => e.NewsId).HasName("PK__News__954EBDD399F42A40");
            ...
            entity.HasOne(d => d.Staff).WithMany(p => p.News)
                .HasForeignKey(d => d.StaffId)
                .HasConstraintName("FK__News__StaffID__787EE5A0");
        });

        modelBuilder.Entity<Notification>(entity =>
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E32DFB0BF9A");
        ...
        {
            entity.HasKey(e => e.PackageId).HasName("PK__Package__322035ECF396AD9F");
        ...
        {
            entity.HasKey(e => e.PackageCategoryId).HasName("PK__PackageC__BAB8ED7EE560DCEA");
        ...
        {
            entity.HasKey(e => e.PackageTestId).HasName("PK__PackageT__DB90EDCE4D6B1B63");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Password__3214EC075D34873E");
        ...
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC346E1B91E87");

            entity.ToTable("Patient");

            entity.HasIndex(e => e.FullName, "IX_Patient_FullName");

            entity.HasIndex(e => e.Email, "UQ__Patient__A9D10534B3D89557").IsUnique();
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__Room__32863919D564148A");
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__Schedule__9C8A5B692039FF3B");
        ...
        {
            entity.HasKey(e => e.RequestId).HasName("PK__Schedule__33A8519A4CDF399C");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__Service__C51BB0EA6AB25B3E");
        ...
        {
            entity.HasKey(e => e.SlotId).HasName("PK__Slot__0A124A4F56D858D2");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__Staff__96D4AAF78DA7C3D9");

            entity.HasIndex(e => e.FullName, "IX_Staff_FullName");

            entity.HasIndex(e => e.Email, "UQ__Staff__A9D1053487E72B56").IsUnique();
        ...
        {
            entity.HasKey(e => e.TestId).HasName("PK__Tests__8CC331000CD65E6C");
        ...
        {
            entity.HasKey(e => e.TestRecordId).HasName("PK__TestReco__1FA0FE96BDD5F93C");
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.TestRecords)
                .HasForeignKey(d => d.AppointmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__TestRecor__Appoi__60A75C0F");

            entity.HasOne(d => d.Doctor).WithMany(p => p.TestRecords)
                .HasForeignKey(d => d.DoctorId)
                .HasConstraintName("FK__TestRecor__Docto__619B8048");

            entity.HasOne(d => d.Test).WithMany(p => p.TestRecords)
                .HasForeignKey(d => d.TestId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__TestRecor__TestI__5FB337D6");
        });

        modelBuilder.Entity<Tracking>(entity =>
        {
            entity.HasKey(e => e.TrackingId).HasName("PK__Tracking__3C19EDD1604340FC");
            ...
            entity.HasOne(d => d.Appointment).WithMany(p => p.Trackings)
                .HasForeignKey(d => d.AppointmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Tracking__Appoin__693CA210");

            entity.HasOne(d => d.Room).WithMany(p => p.Trackings)
                .HasForeignKey(d => d.RoomId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Tracking__RoomID__6B24EA82");

            entity.HasOne(d => d.TestRecord).WithMany(p => p.Trackings)
                .HasForeignKey(d => d.TestRecordId)
                .HasConstraintName("FK__Tracking__TestRe__6A30C649");
        });
