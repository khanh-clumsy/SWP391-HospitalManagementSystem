...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA586AA384D4C");
        ...
        {
            entity.HasKey(e => e.AppointmentId).HasName("PK__Appointm__8ECDFCA2D6851BDC");
        ...
        {
            entity.HasKey(e => e.ConsultantId).HasName("PK__Consulta__E5B83F3908409853");
            ...
            entity.Property(e => e.PatientId).HasColumnName("PatientID");
            entity.Property(e => e.PhoneNumber).HasMaxLength(20);
            entity.Property(e => e.RequestedPersonType).HasMaxLength(20);
            entity.Property(e => e.ServiceId).HasColumnName("ServiceID");
            entity.Property(e => e.Status).HasMaxLength(50);
        ...
        {
            entity.HasKey(e => e.DoctorId).HasName("PK__Doctor__2DC00EDF9D9A04E1");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__Feedback__6A4BEDF6825A6E2B");
        ...
        {
            entity.HasKey(e => e.MedicineId).HasName("PK__Medicine__4F2128F026F1B07B");
        ...
        {
            entity.HasKey(e => e.MedicineListId).HasName("PK__Medicine__B10D21F518F1632C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Password__3214EC079FBC749C");
        ...
        modelBuilder.Entity<Patient>(entity =>
        {
            ...
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC346F97E3C14");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__Room__3286391946965D6C");
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__Schedule__9C8A5B6915E959ED");
        ...
        modelBuilder.Entity<Service>(entity =>
        {
            ...
            entity.HasKey(e => e.ServiceId).HasName("PK__Service__C51BB0EA67C8CDF8");
        ...
        {
            entity.HasKey(e => e.SlotId).HasName("PK__Slot__0A124A4FBF27AC3F");
        ...
        {
            entity.HasKey(e => e.TestId).HasName("PK__Tests__8CC33100DA720E0B");
        ...
        {
            entity.HasKey(e => e.TestListId).HasName("PK__TestList__503ED0280D292A67");
        ...
        {
            entity.HasKey(e => e.TrackingId).HasName("PK__Tracking__3C19EDD12F305A1E");
